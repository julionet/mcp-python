...
if __name__ == "__main__":
    # ✅ host: 127.0.0.1 — só aceita conexões locais (NGINX faz o proxy público)
    # ✅ port: 9000 — conforme planejado
    # ✅ path: parâmetro correto do SDK 2.x
    # ✅ logging no lugar de print()
    logger.info("Servidor MCP ouvindo em http://127.0.0.1:9000/mcp  (Ctrl+C para parar)")
    mcp.run(
        ...
        transport_security=TransportSecuritySettings(
            allowed_hosts=["chronustecnologia.duckdns.org"]
        ),
    )
